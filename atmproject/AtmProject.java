                ...
                do {
                    ...
                    switch (select) {
                        ...
                        case 2:
                            ...
                            if (price > balance) {
                                System.out.println("Bakiye yetersiz. Cekmek istediginiz tutar " + price + 
                                " ancak bakiyeniz " + balance + " isleminize devam edilemiyor, tekrar deneyiniz..." );
                            } else {
                                balance -= price;
                        ...
                        case 4:
                            ...
                            break;
                        default:
                            System.out.println("Gecersiz seçim. Lütfen tekrar deneyin.");
                            break;
                    }
                } while (select != 4);
                break;
